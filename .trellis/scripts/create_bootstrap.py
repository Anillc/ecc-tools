...
2. The `/trellis:before-dev` command will inject real context
3. The `/trellis:check` and `/trellis:check-cross-layer` commands will validate against your actual standards
