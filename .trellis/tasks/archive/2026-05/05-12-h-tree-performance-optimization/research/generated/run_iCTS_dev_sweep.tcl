#===========================================================
# iCTS dev-flow sweep harness.
# Mirrors scripts/design/ics55_dev/script/iCTS_script/run_iCTS_dev.tcl while
# allowing CTS_CONFIG to point at a generated per-case CTS JSON.
#===========================================================

set WORKSPACE           "/home/liweiguo/project/ecc-tools-dev/scripts/design/ics55_dev"
set PDK_DIR             "/home/liweiguo/PDK/icsprout55-pdk"

set RESULT_DIR          "./result"

# input files
set INPUT_DEF           "$RESULT_DIR/bp_be_top_place.def.gz"
...
# script path
set IEDA_CONFIG_DIR     "$WORKSPACE/iEDA_config"
set IEDA_TCL_SCRIPT_DIR "$WORKSPACE/script"
set CTS_CONFIG          "$IEDA_CONFIG_DIR/cts_default_config.json"

#===========================================================
#   override variables from env
#===========================================================
source $IEDA_TCL_SCRIPT_DIR/DB_script/env_var_setup.tcl
if { [info exists ::env(CTS_CONFIG)] } {
...
##   run CTS
#===========================================================
run_cts -config $CTS_CONFIG -work_dir $TOOL_REPORT_DIR
