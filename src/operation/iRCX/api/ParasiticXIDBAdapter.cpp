...
bool ParasiticXIDBAdapter::adapt(LayoutData& layout_data,
...
void ParasiticXIDBAdapter::adaptLayerTable(IdbLayers* idb_layers)
{
...
void ParasiticXIDBAdapter::adaptRoutingLayer(IdbLayers* idb_layers)
{
  // set RoutingLayer
...
void ParasiticXIDBAdapter::adaptSpefContext(IdbDesign* idb_design)
{
...
void ParasiticXIDBAdapter::adaptNet(IdbNetList* idb_netlist)
{
...
Pin ParasiticXIDBAdapter::adaptPin(IdbPin* idb_pin, bool is_driving=false)
{
  Pin pin;
...
Segment ParasiticXIDBAdapter::adaptSegments(IdbRegularWireSegment* idb_seg)
{
...
Patch ParasiticXIDBAdapter::adaptPatch(IdbRegularWireSegment* idb_seg)
{
...
Via ParasiticXIDBAdapter::adaptVia(IdbVia* idb_via)
{
...
void ParasiticXIDBAdapter::adaptSpecialNet(IdbSpecialNetList* idb_special_net_list)
{
...
GtlRectI ParasiticXIDBAdapter::IdbRectToGtlRect(IdbRect* idb_rect) const
{
  return GtlRectI(idb_rect->get_low_x(), idb_rect->get_low_y(),
                  idb_rect->get_high_x(), idb_rect->get_high_y());
}

GtlPointI ParasiticXIDBAdapter::IdbPointToGtlPoint(
