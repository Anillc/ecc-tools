 ...
 * @date 2026-05-19
 * @brief Input-topology adaptation helpers for the bounded-skew router.
 */
...
{
  parameters.topo_type = TopoType::kInputTopo;
  ...
  auto* root = BuildBinaryTopologyNode(input_topology, root_id, parameters, next_steiner_id, owned_nodes);
