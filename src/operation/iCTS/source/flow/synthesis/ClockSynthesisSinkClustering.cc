...
// ***************************************************************************************
/**
 * @file ClockSynthesisSinkClustering.cc
 * @author Dawn Li (dawnli619215645@gmail.com)
 * @date 2026-04-28
 * @brief Implements clustered or direct HTree sink-load preparation for ClockSynthesis.
 */
...
auto PrepareSinkTreeLoads(ClockSynthesis::BuildResult& result, const std::vector<Pin*>& root_loads,
                          const ClockSynthesis::BuildOptions& options) -> SinkTreeLoadPreparation
{
