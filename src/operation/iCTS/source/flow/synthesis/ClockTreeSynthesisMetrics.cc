...
// ***************************************************************************************
/**
 * @file ClockTreeSynthesisMetrics.cc
...
auto absorbSegmentInsertedObjects(ClockSynthesis::SourceToRootBuildResult& result, SourceToRootSegmentBuilder::BuildResult& segment_result)
    -> void
{
...
auto selectedLeafTopologyLevel(const HTreeBuilder::BuildResult& htree_result) -> int
{
...
auto recordClusterSinkNetLevels(ClockSynthesis::BuildResult& result) -> void
{
...
auto RecordTopSegmentResult(ClockSynthesis::SourceToRootBuildResult& result, SourceToRootSegmentBuilder::BuildResult& segment_result)
    -> void
{
