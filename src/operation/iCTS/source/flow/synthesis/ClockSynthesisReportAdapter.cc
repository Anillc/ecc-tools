...
// ***************************************************************************************
/**
 * @file ClockSynthesisReportAdapter.cc
 * @author Dawn Li (dawnli619215645@gmail.com)
 * @date 2026-04-29
 * @brief Clock-tree synthesis report input adapter implementation.
 */
...
auto ClockSynthesisReportAdapter::makeSinkDomainReportInput(const ClockSynthesis::BuildResult& result) -> ClockSinkDomainReportInput
{
  ClockSinkDomainReportInput input{
  ...
  for (const auto& inst : result.inserted_insts) {
    ...
    input.inserted_insts.push_back(ClockTreeReportInstTopology{
        .inst = inst.get(),
  ...
  for (const auto& net : result.inserted_nets) {
    ...
    input.inserted_nets.push_back(ClockTreeReportNetTopology{
        .net = net.get(),
...
auto ClockSynthesisReportAdapter::makeSourceToRootReportInput(const ClockSynthesis::SourceToRootBuildResult& result,
                                                              ClockTreeSynthesisPhase synthesis_phase) -> ClockSourceToRootReportInput
{
  ClockSourceToRootReportInput input{
