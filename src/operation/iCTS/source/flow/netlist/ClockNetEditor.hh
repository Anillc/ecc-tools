...
class ClockNetEditor
{
 public:
  ClockNetEditor() = delete;
  ...
  static auto makeSinkDomainPrefix(const Clock& clock, std::size_t clock_index, CTSSinkDomain sink_domain) -> std::string;
