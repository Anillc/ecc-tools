...
// ***************************************************************************************
/**
 * @file CTSRunEnvironment.cc
 * @author Dawn Li (dawnli619215645@gmail.com)
 * @date 2026-04-28
 * @brief CTS run environment setup and setup-report emission implementation.
 */
...
auto CTSRunEnvironment::initialize(const std::string& config_file, const std::string& work_dir) -> void
{
...
auto CTSRunEnvironment::emitRuntimeSetup() -> void
{
