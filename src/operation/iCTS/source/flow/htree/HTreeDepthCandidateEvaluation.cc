...
// ***************************************************************************************
/**
 * @file HTreeDepthCandidateEvaluation.cc
    ...
    -> HTreeDepthCandidateEvaluationResult
{
  ...
  HTreeDepthCandidateEvaluationResult candidate_result;
  ...
  candidate_result.evaluation = EvaluateCandidateBuild(candidate_levels, entry_sets_by_length, segment_pattern_registry, candidate_options,
                                                       topology, actual_load_legality_context, leaf_count, depth, char_slew_steps);
