 ...
 * @date 2026-04-28
 * @brief CTS run setup and setup-report emission implementation.
 */
...
auto CTSRunSetup::initialize(const std::string& config_file, const std::string& work_dir) -> void
{
...
auto CTSRunSetup::emitRuntimeSetup() -> void
{
