...
// ***************************************************************************************
/**
 * @file ClockTreeSvgVisualization.cc
...
auto EmitClockTreeSvgVisualizations(const std::filesystem::path& visualization_dir, const ClockTreeView& clock_tree_view)
    -> ClockTreeSvgVisualizationResult
{
  ...
  if (!model.has_clocks) {
    ...
    return ClockTreeSvgVisualizationResult{.success = false};
  }
  ...
  return ClockTreeSvgVisualizationResult{.success = success};
}
