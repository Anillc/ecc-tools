...
// ***************************************************************************************
/**
 * @file LinearClusteringRealTechElectricalTest.cc
 * @author Dawn Li (dawnli619215645@gmail.com)
 * @date 2026-04-11
 * @brief Real-tech linear clustering electrical regression tests.
 */
...
TEST(LinearClusteringRealTechElectricalTest, RealTechExactCapRootCollisionIsLegalizedBeforeRouting)
{
