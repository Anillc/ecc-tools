...
struct RealTechCharSession
{
  ...
  RealTechCharSession(const RealTechCharSession&) = delete;
  auto operator=(const RealTechCharSession&) -> RealTechCharSession& = delete;
  RealTechCharSession(RealTechCharSession&&) = delete;
