...
// ***************************************************************************************
/**
 * @file TopologyRealTechMatrixSupport.cc
 * @author Dawn Li (dawnli619215645@gmail.com)
 * @date 2026-04-24
 * @brief BP placement real-tech matrix support for Topology smoke tests.
 */
...
auto EvaluateArm9FullSinkTopologyToleranceComparison() -> TopologyToleranceComparisonResult
{
  ...
  realtech_support::RealTechCharSession char_session;
  if (const auto prepare_error = char_session.prepare("topology_arm9_full_sink_topology_tolerance", std::nullopt, kSynthesisSmokeMaxSlewNs,
