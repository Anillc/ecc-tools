...
// ***************************************************************************************
/**
 * @file ClockSynthesisRealTechClusterAssertions.cc
 * @author Dawn Li (dawnli619215645@gmail.com)
 * @date 2026-04-24
 * @brief GTest adapters for ClockSynthesis real-tech cluster validation.
 */
...
auto EmitValidationFailures(const ClockSynthesisValidationResult& validation) -> void
{
