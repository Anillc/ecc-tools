...
// ***************************************************************************************
/**
 * @file ClockSynthesisVisualizationSupport.cc
...
auto CollectExtraPoints(const icts::ClockSynthesis::BuildResult& result) -> std::vector<icts::Point<int>>
{
...
auto CollectSinkLevelSegments(const icts::ClockSynthesis::BuildResult& result) -> std::vector<LineSegment>
{
...
auto CollectHtreeTerminalLoads(const std::vector<icts::Pin*>& original_sinks, const icts::ClockSynthesis::BuildResult& result)
...
auto BuildReport(const std::string& scenario_name, const std::string& clock_name, const ClockSynthesisArtifactPaths& paths,
                 icts::Pin* source, const std::vector<icts::Pin*>& original_sinks, const icts::ClockSynthesis::BuildResult& result)
    -> std::string
{
...
{
  ClockSynthesisArtifactPaths paths;
