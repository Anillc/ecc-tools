...
// ***************************************************************************************
/**
 * @file HTreeBuilderRealTechSmokeSupport.hh
...
inline constexpr std::string_view kArm9ExperimentScenario = "htree_builder_arm9_full_sink_matrix";
inline constexpr std::string_view kArm9ExperimentAutoUnitScenario = "htree_builder_arm9_full_sink_matrix_auto_unit";
